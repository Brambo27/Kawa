...
extension Array where Element == ScheduleItem {
    static let sampleData: [ScheduleItem] = {
        [
            ...
            ScheduleItem(id: 28, classId: 1, title: "Assignment Due Tomorrow", groupId: 1, dateTime: Date.startOfWeek.adding(days: -3), courseId: 1, teacher: nil, type: "announcement", location: nil),
            ScheduleItem(id: 29, classId: 1, title: "Beach cleanup", groupId: 1, dateTime: Date.startOfWeek.adding(days: 3), courseId: 1, teacher: nil, type: "event", location: nil)
        ]
    }()
}
